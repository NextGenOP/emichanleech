...
async def save_thumb_nail(client, message):
    ...
    if message.reply_to_message is not None:
        ...
        await ismgs.edit(
            "Gambar Thumbnail telah disimpan" + \
            "Gambar ini akan selalu digunakan sampai anda mengirim /hapusgambar"
        )
    else:
        await message.edit("Balas ke foto yang akan dijadikan thumbnail")
...
async def clear_thumb_nail(client, message):
    ...
    await ismgs.edit("✅ Gambar dihapus.")

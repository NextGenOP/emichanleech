    ...
    if os.path.isdir(local_file_name):
        ...
        if os.path.getsize(local_file_name) > TG_MAX_FILE_SIZE:
            ...
            i_m_s_g = await message.reply_text(
                "Telegran tidak mendukung file ini.\n"
                f"Ukuran file: {d_f_s} 😡\n"
                "\n🤖 Membagi menjadi beberapa file.🌝🌝🌚"
            )
            ...
            await i_m_s_g.edit_text(
                f"Ukuran File: {d_f_s} 😡\n"
                f"<code>{ba_se_file_name}</code> membagi menjadi {number_of_files} file.\n"
                "Mencoba mengunggah ke Telegram..."
            )
